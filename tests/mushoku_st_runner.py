"""
Persistent headless ST WebUI runner (MUSHOKU isolation variant).
...
Variant: MUSHOKU isolation stack (ST :8015 / bridge WS :8016).
Differs from dm_st_runner.py only in pidfile name + log context.

Run:
    ./venv/bin/python tests/mushoku_st_runner.py
"""
...
PID_FILE = HERE / "logs" / "mushoku-st-runner.pid"
